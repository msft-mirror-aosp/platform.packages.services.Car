...
public final class CarUiPortraitHomeScreen extends FragmentActivity {
    ...
    private final TaskStackListener mTaskStackListener = new TaskStackListener() {
        ...
        //TODO(b/332936459): investigate corner case for opening panel w/o onTaskMovedToFront
        @Override
    ...
    private void handleAppMovedToFront(ActivityManager.RunningTaskInfo taskInfo,
        ...
        if (mIsNotificationCenterOnTop || mIsRecentsOnTop || mIsAppGridOnTop) {
    ...
    private void handleTaskStackChange(ActivityManager.RunningTaskInfo taskInfo,
        ...
        handleAppMovedToFront(taskInfo, reason);
