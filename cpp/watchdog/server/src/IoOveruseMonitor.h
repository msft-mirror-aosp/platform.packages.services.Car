...
public:
    ...
    android::base::Result<void> onBoottimeCollection(
            [[maybe_unused]] time_point_ms time,
    ...
    android::base::Result<void> onUserSwitchCollection(
            [[maybe_unused]] time_point_ms time, [[maybe_unused]] userid_t from,
...
private:
    ...
    time_point_ms mLastUserPackageIoMonitorTime GUARDED_BY(mRwMutex);
