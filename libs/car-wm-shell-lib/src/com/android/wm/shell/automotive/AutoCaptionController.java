...
public class AutoCaptionController {
     ...
     *
     * <p>Calling this API for same displayId would update the caption region. To set the safe
     * region, use {@link AutoLayoutManager#setOrUpdateSafeRegion}.
     *
     ...
     *
     * @param taskInfo       The running task information.
     * @param captionRegionInfo The safe area information containing caption bar details.
     */
    private void attachCaptionBar(ActivityManager.RunningTaskInfo taskInfo,
        ...
        // Attach the caption bar with spy window so that touch also travels to the task surface
